...
keypath="/base/audio/codec/headphone_volume_adjust"
...
ttips "Start playing with headphone (repeat $playback_repeat_times times)"
...
ttrue "Does headphone volume adjustment work well?"
if [ $? -eq "0" ]; then
    exit 0
else
    exit 1
