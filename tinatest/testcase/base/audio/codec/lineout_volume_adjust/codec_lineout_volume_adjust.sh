...
keypath="/base/audio/codec/lineout_volume_adjust"
...
ttips "Start playing with line out (repeat $playback_repeat_times times)"
...
ttrue "Does line out volume adjustment work well?"
if [ $? -eq "0" ]; then
    exit 0
else
    exit 1
